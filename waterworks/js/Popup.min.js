class Popup {
  constructor(g) {
    _defineProperty(this, "hide", () => {
      this.buttonNo.hover.input.enabled = !1, this.buttonYes.hover.input.enabled = !1, this.phaser.tweens.add({
        ...
        ease: "Cubic.In",
        onComplete: function() {
          this.container.visible = !1, this.background.setTexture("gui", "popup"), this.container.y = POPUP_Y, this.img.visible = !1, this.buttonNo.setPosition(-50, this.background.height / 2 - 45), this.buttonYes.setPosition(50, this.background.height / 2 - 45), this.title.y = .4 * -this.background.height, this.description.y = this.title.y + 20, this.buttonsY = this.background.height / 2 - 45, this.title.setMaxWidth(CONSTRUCTION_CARDS_MARGIN_LEFT - 4 * CONSTRUCTION_CARDS_MARGIN), this.description.setMaxWidth(CONSTRUCTION_CARDS_MARGIN_LEFT - 4 * CONSTRUCTION_CARDS_MARGIN)
        },
        onCompleteScope: this
      }), 0 == this.game.construction.open && 0 == this.game.request.open && 0 == this.game.options.container.visible ? this.game.hideCurtain() : 0 == this.game.options.container.visible ? this.game.showCurtain(.5, LAYER_CONSTRUCTION - 1) : this.game.showCurtain(.5, LAYER_GUI_OPTIONS - 1), this.closeSound.play()
    }), _defineProperty(this, "showBig", (img, title, message, yesFunction, noFunction) => {
      this.title.text = title.toUpperCase(), this.description.text = message, this.title.setMaxWidth(360), this.description.setMaxWidth(360), this.img.setTexture("constructions", img), this.img.visible = !0;
      var imgY = -130;
      this.description.height + this.img.displayHeight > 120 ? (this.background.setTexture("gui", "popup2"), this.container.y = POPUP_Y2) : (this.background.setTexture("gui", "popup3"), this.container.y = POPUP_Y, imgY = -85), this.img.y = imgY, this.title.y = this.img.y + this.img.height, this.description.y = this.title.y + 12, this.buttonsY = this.description.y + this.description.height + 25, this.description.height + this.img.displayHeight > 120 ? this.buttonsY < 100 && (this.buttonsY = 100) : this.buttonsY < 50 && (this.buttonsY = 50), this.show(title, message, yesFunction, noFunction)
    }), _defineProperty(this, "show", (title, message, yesFunction, noFunction) => {
      this.container.visible = !0, this.openSound.play(), this.phaser.tweens.killTweensOf(this.container), this.container.scale = .5, this.phaser.tweens.add({
        targets: [this.container],
        alpha: 1,
        scale: 1,
        visible: !0,
